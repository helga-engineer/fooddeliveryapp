...
<div class="page-content-wrapper">
    ...
    <div class="page-content" style="min-height: 1603px;">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">Add Menu Category</span>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
            ...
            <div class="col-md-12">
                <div class="portlet box green">
                    ...
                    <div class="portlet-body form">
                        ...
                        <form name="add" id="add" method="post" enctype="multipart/form-data" action="<?php echo site_url('admin/restaurant_menu_categories/addSuccess'); ?>" class="form-horizontal">
                            <input type="hidden" name="restaurant_id" value="<?php echo $restaurant_id;?>"/>
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Category Name</label>
                                    <div class="col-md-4">
                                        <input type="text" name="title" id="title" class="form-control input-circle" placeholder="Enter Name">
