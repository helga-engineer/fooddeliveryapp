...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Restaurants | Admin Login</title>
    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo site_url('admin/login/auth');?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="email" autocomplete="off" placeholder="Email" name="user_email" /> </div>
                </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                    <div class="input-icon">
                        <i class="fa fa-lock"></i>
                        <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="user_password" /> </div>
                </div>
