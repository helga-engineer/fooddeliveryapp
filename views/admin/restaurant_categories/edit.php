            ...
            <div class="col-md-12">
                <div class="portlet box green">
                    ...
                    <div class="portlet-body form">
                        ...
                        <form name="add" id="add" method="post" enctype="multipart/form-data" action="<?php echo site_url('admin/categories/editSuccess'); ?>" class="form-horizontal">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <select class="form-control input-circle" name="status" id="status">
                                                     ...
                                                     <option value="Active" <?php if($categories->active == 'Active'){ echo 'selected="selected"'; }?>>Active</option>
                                                    <option value="Not Active" <?php if($categories->active == 'Not Active'){ echo 'selected="selected"'; }?>>Inactive</option>
