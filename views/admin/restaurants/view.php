                                       ...
                                       <?php   if (count($restaurants) > 0) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $restaurant->phone; ?></td>
                                                 ...
                                                 <td><div class="btn-group btn-group-circle btn-group-solid">
                                                         <a href="<?php echo site_url();?>admin/menus/add?id=<?php echo  $restaurant->id;?>" class="btn green">Add<i class="fa fa-plus"></i></a>
                                                         <a href="<?php echo site_url();?>admin/menus/viewMenus?id=<?php echo  $restaurant->id;?>" class="btn blue">View<i class="fa fa-expand"></i></a>
                                                            </div></td>
